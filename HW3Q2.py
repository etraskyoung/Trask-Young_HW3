...
class DecisionNode(Node):
    ...
    def get_expected_utilities(self):
        "returns the expected tilities of future nodes"
        outcomes2 = dict()
        for node in self.futureNode:
            outcomes2[node.name] = node.get_expected_utility()
        return outcomes2
#######################
...
print('Expected Costs for D1', D1.get_expected_costs())
print('Expected Utilities for D1', D1.get_expected_utilities())
